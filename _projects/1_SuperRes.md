...
<div class="row justify-content-sm-center">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Project_SR_Fig_SuperRes.png" title="SR illustration" width="600px" align="center" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
